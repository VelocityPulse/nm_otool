...
/*   Updated: 2018/04/09 16:05:42 by cchameyr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../incl/ft_nm.h"

void	init_sub_nm_data(t_data *sub_nm_data, char *ptr, int offset)
{
...
void	handle_fat32(t_data *nm_data, char *ptr)
{
	...
	trigger_false_pointer(nm_data, (void *)f_header);
	trigger_false_pointer(nm_data, nm_data->ptr + nm_bsp32(nm_data, fa->size));
	init_sub_nm_data(&sub_nm_data, (void *)f_header,
